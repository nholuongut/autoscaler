...
Full API is accessible [here](https://github.com/nholuongut/autoscaler/blob/master/vertical-pod-autoscaler/pkg/apis/autoscaling.k8s.io/v1beta2/types.go).
...
for instructions on switching to 0.3.X see the [0.3 version README](https://github.com/nholuongut/autoscaler/blob/vpa-release-0.3/vertical-pod-autoscaler/README.md)
