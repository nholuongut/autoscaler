...
Open a new issue to track the release, use the [vpa_release](https://github.com/nholuongut/autoscaler/issues/new?&template=vpa_release.md) template.
...
1. [ ] Change the version in
    [common/version-go](https://github.com/nholuongut/autoscaler/blob/master/vertical-pod-autoscaler/common/version.go)
    to `1.${next-minor}.0`,
...
For example:
```sh
git clone git@github.com:nholuongut/autoscaler.git
...
1.  [ ] [Run](https://github.com/nholuongut/autoscaler/blob/master/vertical-pod-autoscaler/hack/run-e2e-tests.sh)
...
1.  [ ] Update information about newest version and K8s compatibility in
    [the installation section of README](https://github.com/nholuongut/autoscaler/blob/master/vertical-pod-autoscaler/README.md#installation).
...
1.  [ ] Update the yaml files:
    ...
    ```
1.  [ ] Update the default tag in  [vpa-up.sh](https://github.com/nholuongut/autoscaler/blob/master/vertical-pod-autoscaler/hack/vpa-up.sh).

1.  [ ] Merge these changes into branch vpa-release-1.{$minor} and optionally into master if 1.{$minor} is the latest minor release
    (example PR: [#5460](https://github.com/nholuongut/autoscaler/pull/5460)).
...
1.  [ ] Push tag
    ...
    ```sh
    git push git@github.com:nholuongut/autoscaler.git vertical-pod-autoscaler-[*vpa-version*]
    git push git@github.com:nholuongut/autoscaler.git vertical-pod-autoscaler/v[*vpa-version*]
    ```

1.  [ ] To create and publish a github release from pushed tag go to
    https://github.com/nholuongut/autoscaler/releases/tag/vertical-pod-autoscaler-[*vpa-version*],
...
* Permissions to add tags to
    [nholuongut/autoscaler](https://github.com/nholuongut/autoscaler) and create
    releases in the repo you must be:

    *   a collaborator on the
        [nholuongut/autoscaler](https://github.com/nholuongut/autoscaler) repo
        or
    *   a member of the
