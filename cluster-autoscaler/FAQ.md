...
* [Cluster Autoscaler 0.5.X](https://github.com/nholuongut/autoscaler/blob/cluster-autoscaler-release-0.5/cluster-autoscaler/FAQ.md)
* [Cluster Autoscaler 0.6.X](https://github.com/nholuongut/autoscaler/blob/cluster-autoscaler-release-0.6/cluster-autoscaler/FAQ.md)
...
See [Cluster Autoscaler Releases](https://github.com/nholuongut/autoscaler/tree/master/cluster-autoscaler#releases).
...
* It was tested that CA scales well. CA should handle up to 1000 nodes running 30 pods each. Our testing procedure is described
   [here](https://github.com/nholuongut/autoscaler/blob/master/cluster-autoscaler/proposals/scalability_tests.md).
...
available [here](https://github.com/nholuongut/autoscaler/blob/master/cluster-autoscaler/proposals/metrics.md).
...
For AWS using kops, see [this issue](https://github.com/nholuongut/autoscaler/issues/1410#issuecomment-439840945).
...
[original proposal](https://github.com/nholuongut/autoscaler/blob/master/cluster-autoscaler/proposals/provisioning-request.md).
...
3. __Content Type__: Set [API content type flag](https://github.com/nholuongut/autoscaler/blob/522c6fcc06c8cf663175ba03549773cc66a02837/cluster-autoscaler/main.go#L114) to application/json in your Cluster Autoscaler configuration: `--kube-api-content-type application/json`.
...
5. Deploy the [ProvisioningRequest CRD](https://github.com/nholuongut/autoscaler/blob/master/cluster-autoscaler/apis/config/crd/autoscaling.x-k8s.io_provisioningrequests.yaml)
...
CA team follows the generic Kubernetes process and submits design proposals [HERE](https://github.com/nholuongut/autoscaler/tree/master/cluster-autoscaler/proposals)
before starting any significant effort.
Some of the not-yet-fully-approved proposals may be hidden among [PRs](https://github.com/nholuongut/autoscaler/pulls).
...
[HERE](https://github.com/nholuongut/autoscaler/blob/master/cluster-autoscaler/proposals/pricing.md). Currently it works only for GCE, GKE and Equinix Metal (patches welcome.)
...
4. Describe your testing in PR description or in a separate comment on your PR
   (example:
   <https://github.com/nholuongut/autoscaler/pull/74#issuecomment-302434795>).
