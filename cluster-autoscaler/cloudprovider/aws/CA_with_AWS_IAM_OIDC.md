...
```sh
$ wget https://raw.githubusercontent.com/nholuongut/autoscaler/master/cluster-autoscaler/cloudprovider/aws/examples/cluster-autoscaler-autodiscover.yaml
```
...
[//]: # 
   ...
   [Cluster Autoscaler Auto-Discovery]: <https://github.com/nholuongut/autoscaler/blob/master/cluster-autoscaler/cloudprovider/aws/examples/cluster-autoscaler-autodiscover.yaml>
