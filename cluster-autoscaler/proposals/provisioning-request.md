...
2.  Scale-up logic, which as of now has no notion atomicity and grouping of
    ...
    interface](https://github.com/nholuongut/autoscaler/pull/5597).
...
4.  Scale down path is not expected to change much. But users should follow
    [best
    practices](https://github.com/nholuongut/autoscaler/blob/master/cluster-autoscaler/FAQ.md#what-types-of-pods-can-prevent-ca-from-removing-a-node)
